...
*Playbulb IFTTT* is a tool that can connect IFTTT (If This, Then That, [ifttt.com](ifttt.com)) to the Playbulb Candles ([http://www.playbulb.com](http://www.playbulb.com)).
